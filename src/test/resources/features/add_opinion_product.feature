...
Característica: Add opinion
  ...
  Escenario: agregar una opinion a un producto
    Cuando "Messi" quiere agregar un comentario al producto "iphone11". Con "4" estrellas, la frase "me gusta", la opinion "buen producto", si lo recomienda como "Si" y correo "elcorreo@correo.com"
